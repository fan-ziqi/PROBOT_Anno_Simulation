...
class GraspingDemo
{
  ...
  public:
	/**
 	 ...
 	 */
	GraspingDemo(ros::NodeHandle n_, float pregrasp_x, float pregrasp_y, float pregrasp_z, float length = 1, float breadth = 0.6, int color = 2);
	/**
	 ...
	 */
	void initiateGrasping(int color);
	/**
